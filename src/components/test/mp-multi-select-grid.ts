...
@customElement('mp-multi-select-grid')
export class MultiSelectGrid extends LitElement {
  static styles = css`
      :host {
  ...
  render() {
      ...
      return html`
        ...
        <div part="main-container" id="container">
           <div id="header-row">
                <div class="open-icon" part="icon-container" @click=${this.detailsToggle}>
...
declare global {
  interface HTMLElementTagNameMap {
    'mp-multi-select-grid': MultiSelectGrid;
  }
}
